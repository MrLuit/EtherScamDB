window.addEventListener("load", function() {
    $.getJSON("https://freegeoip.net/json/" + $("h1").html(), function(data) {
        ...
        $("#map").html('<iframe width="100%" height="400px" frameborder="0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyBw2MrKbJrjg6NYIq6kClIVvUx3vSj-a1s&q=' + data.latitude + ',' + data.longitude + '" allowfullscreen></iframe>');
    });
	setTimeout(function() {
